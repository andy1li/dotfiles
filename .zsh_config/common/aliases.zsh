...
alias gc1='f() { g clone --depth 1 "$1" && cd "$(basename "$1" .git)" && c .; }; f'
...
alias gcm='g commit -m "$(gd --staged | sgpt stdin -m "gpt-4o" "Write a concise commit message for the changes using the Conventional Commits specification. Do not use triple backticks.")"'
alias gcp="gcm && gp"
